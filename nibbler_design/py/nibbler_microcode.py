...
def gen_lines (uop_idx, repeat_cnt, signal, cp0_wen, pc_mux_sel, a_mux_sel, a_rd_tmp, rf_acc_dir, a_addr, b_addr, wb_addr, mem_acc, wb_en, wb_tmp_en, a_use_temp_reg, b_imm_used, b_imm_type, b_imm_en, b_imm_sel, b_imm_zero, addsub_fn, carry_in, logic_fn, adj_sel, adj_en, wb_off_sel, fn_type, fl_en, addr_dir, addr_en, br_reg_en, new_inst):
